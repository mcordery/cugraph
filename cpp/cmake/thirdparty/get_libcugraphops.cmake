...
#
# To use a locally-built cugraph-ops package, set the CMake variable `-D cugraph-ops_ROOT=/path/to/cugraph-ops/build`
#
find_and_configure_cugraph_ops(
    VERSION
    ${CUGRAPH_MIN_VERSION_cugraph_ops}
    REPO
    ${CUGRAPH_CUGRAPH_OPS_REPOSITORY}
    PINNED_TAG
    ${CUGRAPH_CUGRAPH_OPS_BRANCH}
    BUILD_STATIC
    ${CUGRAPH_USE_CUGRAPH_OPS_STATIC}
    EXCLUDE_FROM_ALL
    ${CUGRAPH_EXCLUDE_CUGRAPH_OPS_FROM_ALL}
    # Allow cloning cugraph-ops in cases when we expect the local copy of cugraph-ops to not be the one that we want.
    # Cases include static linking such that we need to compile a static lib or during development when using a
