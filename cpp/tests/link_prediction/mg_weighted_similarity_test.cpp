...
TEST_P(Tests_MGWeightedSimilarity_File, CheckInt32Int32FloatFloatCosine)
{
  auto param = GetParam();
  run_current_test<int32_t, int32_t, float>(
...
TEST_P(Tests_MGWeightedSimilarity_Rmat, CheckInt32Int32FloatFloatCosine)
{
  auto param = GetParam();
  run_current_test<int32_t, int32_t, float>(
...
TEST_P(Tests_MGWeightedSimilarity_Rmat, CheckInt64Int64FloatFloatCosine)
{
  auto param = GetParam();
  run_current_test<int64_t, int64_t, float>(
    override_Rmat_Usecase_with_cmd_line_arguments(GetParam()), cugraph::test::test_cosine_t{});
