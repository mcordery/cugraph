...
struct ConvOutputIteratorParameter {
  ...
  CUTLASS_HOST_DEVICE
  static OutputIteratorLayout layout(const TensorRef& ref) { return ref.stride(kTensorStrideIdx); }
...
struct ConvOutputIteratorParameter<layout::TensorNCxHWx<InterleavedK>,
  ...
  CUTLASS_HOST_DEVICE
  static OutputIteratorLayout layout(const TensorRef& ref) { return ref.stride(); }
