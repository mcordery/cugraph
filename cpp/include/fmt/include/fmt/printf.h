...
class printf_arg_formatter : public arg_formatter<Char> {
 ...
 public:
  ...
  void operator()(T value)
  {
    ...
    if (s.align == align::none || s.align == align::numeric) s.align = align::right;
...
void vprintf(buffer<Char>& buf, basic_string_view<Char> format, basic_format_args<Context> args)
{
  ...
  while (it != end) {
    ...
    if (specs.type == presentation_type::none) report_error("invalid format specifier");
    specs.upper = upper;
