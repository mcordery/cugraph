...
FMT_FUNC void format_error_code(detail::buffer<char>& out,
                                int error_code,
                        ...
                        locale_ref loc) -> bool
{
  ...
  value.visit(loc_writer<>{out, specs, std::string(1, FMT_STATIC_THOUSANDS_SEPARATOR), "\3", "."});
  return true;
#else
...
FMT_FUNC void report_error(const char* message) { FMT_THROW(format_error(message)); }
...
FMT_INLINE decimal_fp<T> shorter_interval_case(int exponent) noexcept
{
  ...
  if (exponent >= float_info<T>::shorter_interval_tie_lower_threshold &&
    ...
    ret_value.significand =
      ret_value.significand % 2 == 0 ? ret_value.significand : ret_value.significand - 1;
...
auto to_decimal(T x) noexcept -> decimal_fp<T>
{
  ...
  uint32_t r =
    static_cast<uint32_t>(z_mul.result - float_info<T>::big_divisor * ret_value.significand);
...
class file_base {
 ...
 public:
  ...
  void unget(char c)
  {
    if (ungetc(c, file_) == EOF) FMT_THROW(system_error(errno, FMT_STRING("ungetc failed")));
  }
...
FMT_FUNC auto is_printable(uint32_t cp) -> bool
{
  ...
  static constexpr unsigned char singletons0_lower[] = {
    ,
  };
  ...
  static constexpr unsigned char singletons1_lower[] = {
    ...
    ,
  };
  static constexpr unsigned char normal0[] = {
    ,
  };
  static constexpr unsigned char normal1[] = {
    0x5e, 0x22, 0x7b, 0x05, 0x03, 0x04, 0x2d, 0x03, 0x66, 0x03, 0x01, 0x2f, 0x2e, 0x80, 0x82, 0x1d,
    ...
    ,
  };
  auto lower = static_cast<uint16_t>(cp);
  if (cp < 0x10000) {
    return is_printable(lower,
                        singletons0,
