...
class tcp_sink : public spdlog::sinks::base_sink<Mutex> {
 public:
  ...
  {
    if (!config_.lazy_connect) { this->client_.connect(config_.server_host, config_.server_port); }
  }
 ...
 protected:
  void sink_it_(const spdlog::details::log_msg& msg) override
  {
    ...
    if (!client_.is_connected()) { client_.connect(config_.server_host, config_.server_port); }
