...
{
  return vformat_to(
    out, detail::to_string_view(fmt), fmt::make_format_args<buffer_context<Char>>(args...));
}
...
{
  return vformat_to_n(
    out, n, detail::to_string_view(fmt), fmt::make_format_args<buffer_context<Char>>(args...));
}
...
inline auto formatted_size(const S& fmt, T&&... args) -> size_t
{
  ...
  detail::vformat_to(
    buf, detail::to_string_view(fmt), fmt::make_format_args<buffer_context<Char>>(args...));
  return buf.count();
}
