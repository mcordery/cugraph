...
template <class _Cp>
_LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX14 auto begin(_Cp& __c)
  -> decltype(__c.begin())
{
  return __c.begin();
}
...
template <class _Cp>
_LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX14 auto begin(const _Cp& __c)
  -> decltype(__c.begin())
{
  return __c.begin();
}
...
template <class _Cp>
_LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX14 auto end(_Cp& __c)
  -> decltype(__c.end())
{
  return __c.end();
}
...
template <class _Cp>
_LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX14 auto end(const _Cp& __c)
  -> decltype(__c.end())
{
  return __c.end();
}
...
template <class _Cp>
_LIBCUDACXX_INLINE_VISIBILITY typename _Cp::iterator begin(_Cp& __c)
{
  return __c.begin();
}

template <class _Cp>
_LIBCUDACXX_INLINE_VISIBILITY typename _Cp::const_iterator begin(const _Cp& __c)
{
  return __c.begin();
}

template <class _Cp>
_LIBCUDACXX_INLINE_VISIBILITY typename _Cp::iterator end(_Cp& __c)
{
  return __c.end();
}

template <class _Cp>
_LIBCUDACXX_INLINE_VISIBILITY typename _Cp::const_iterator end(const _Cp& __c)
{
  return __c.end();
}
