...
#if defined(_LIBCUDACXX_IS_NOTHROW_ASSIGNABLE) && \
  !defined(_LIBCUDACXX_USE_IS_NOTHROW_ASSIGNABLE_FALLBACK)
...
template <class _Tp, class _Arg>
_LIBCUDACXX_INLINE_VAR constexpr bool is_nothrow_assignable_v =
  _LIBCUDACXX_IS_NOTHROW_ASSIGNABLE(_Tp, _Arg);
#endif
...
struct __libcpp_is_nothrow_assignable<true, _Tp, _Arg>
  : public integral_constant<bool,
                             noexcept(_CUDA_VSTD::declval<_Tp>() = _CUDA_VSTD::declval<_Arg>())> {};
...
#endif  // defined(_LIBCUDACXX_HAS_NOTHROW_ASSIGN) &&
        // !defined(_LIBCUDACXX_USE_HAS_NOTHROW_ASSIGN_FALLBACK)
