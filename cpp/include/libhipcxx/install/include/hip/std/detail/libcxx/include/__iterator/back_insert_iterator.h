...
class _LIBCUDACXX_TEMPLATE_VIS back_insert_iterator
 ...
 public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY explicit back_insert_iterator(_Container& __x)
    : container(_CUDA_VSTD::addressof(__x))
  {
  }
  _LIBCUDACXX_INLINE_VISIBILITY back_insert_iterator& operator=(
  ...
  {
    container->push_back(_CUDA_VSTD::move(__value_));
    return *this;
  }
...
template <class _Container>
inline _LIBCUDACXX_INLINE_VISIBILITY back_insert_iterator<_Container> back_inserter(_Container& __x)
{
