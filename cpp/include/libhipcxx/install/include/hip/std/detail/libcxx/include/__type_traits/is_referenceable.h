...
struct __libcpp_is_referenceable
  : integral_constant<
      bool,
      _IsNotSame<decltype(__libcpp_is_referenceable_impl::__test<_Tp>(0)), false_type>::value> {};
#endif  // defined(_LIBCUDACXX_IS_REFERENCEABLE) &&
        // !defined(_LIBCUDACXX_USE_IS_REFERENCEABLE_FALLBACK)
