...
template <template <class, class, class, class> class _Sp,
          class _Tp,
          class _A0,
          class _A1,
          class _A2>
...
struct _LIBCUDACXX_TEMPLATE_VIS pointer_traits {
 ...
 public:
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 static pointer pointer_to(
...
struct _LIBCUDACXX_TEMPLATE_VIS pointer_traits<_Tp*> {
 ...
 public:
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 static pointer pointer_to(
    __conditional_t<is_void<element_type>::value, __nat, element_type>& __r) _NOEXCEPT
  {
...
template <class _Tp>
_LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR _Tp* __to_address(_Tp* __p) _NOEXCEPT
{
...
struct _HasToAddress<_Pointer,
                     decltype((void)pointer_traits<_Pointer>::to_address(
                       declval<const _Pointer&>()))> : true_type {};
...
template <class _Pointer,
          class = __enable_if_t<_And<is_class<_Pointer>, _IsFancyPointer<_Pointer>>::value>>
...
struct __to_address_helper {
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR static decltype(_CUDA_VSTD::__to_address(
...
struct __to_address_helper<_Pointer,
  ...
  _LIBCUDACXX_CONSTEXPR static decltype(pointer_traits<_Pointer>::to_address(
    declval<const _Pointer&>()))
  __call(const _Pointer& __p) _NOEXCEPT
  {
