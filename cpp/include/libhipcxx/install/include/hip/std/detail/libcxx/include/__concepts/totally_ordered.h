...
template <class _Tp, class _Up>
_LIBCUDACXX_CONCEPT_FRAGMENT(__partially_ordered_with_,
...
template <class _Tp, class _Up>
_LIBCUDACXX_CONCEPT __partially_ordered_with =
  _LIBCUDACXX_FRAGMENT(__partially_ordered_with_, _Tp, _Up);

template <class _Tp>
_LIBCUDACXX_CONCEPT_FRAGMENT(__totally_ordered_,
                             requires()(requires(equality_comparable<_Tp>),
...
_LIBCUDACXX_CONCEPT_FRAGMENT(
  ...
  requires()(requires(totally_ordered<_Tp>),
             ...
             requires(totally_ordered<common_reference_t<__make_const_lvalue_ref<_Tp>,
