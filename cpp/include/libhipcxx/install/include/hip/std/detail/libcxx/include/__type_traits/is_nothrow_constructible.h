...
#if defined(_LIBCUDACXX_IS_NOTHROW_CONSTRUCTIBLE) && \
...
_LIBCUDACXX_INLINE_VAR constexpr bool is_nothrow_constructible_v =
  _LIBCUDACXX_IS_NOTHROW_CONSTRUCTIBLE(_Tp, _Args...);
#endif
...
struct __libcpp_is_nothrow_constructible</*is constructible*/ true,
  ...
  : public integral_constant<bool,
                             noexcept(__implicit_conversion_to<_Tp>(_CUDA_VSTD::declval<_Arg>()))> {
};
...
#if defined(_LIBCUDACXX_HAS_NOTHROW_CONSTRUCTOR) && \
...
#endif  // defined(_LIBCUDACXX_HAS_NOTHROW_CONSTRUCTOR) &&
        // !defined(_LIBCUDACXX_USE_HAS_NOTHROW_CONSTRUCTOR_FALLBACK)
{
};
...
#else
  : integral_constant<bool, is_scalar<_Tp>::value>
#endif  // defined(_LIBCUDACXX_HAS_NOTHROW_COPY) &&
        // !defined(_LIBCUDACXX_USE_HAS_NOTHROW_COPY_FALLBACK)
{
};
...
#endif  // defined(_LIBCUDACXX_IS_NOTHROW_CONSTRUCTIBLE) &&
        // !defined(_LIBCUDACXX_USE_IS_NOTHROW_CONSTRUCTIBLE_FALLBACK)
