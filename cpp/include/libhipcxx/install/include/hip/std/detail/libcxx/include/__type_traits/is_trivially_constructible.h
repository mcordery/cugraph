...
#if defined(_LIBCUDACXX_IS_TRIVIALLY_CONSTRUCTIBLE) && \
...
#if defined(_LIBCUDACXX_HAS_TRIVIAL_CONSTRUCTOR) && \
  !defined(_LIBCUDACXX_USE_HAS_TRIVIAL_CONSTRUCTOR_FALLBACK)
  : integral_constant<bool, _LIBCUDACXX_HAS_TRIVIAL_CONSTRUCTOR(_Tp)>
#else
  : integral_constant<bool, is_scalar<_Tp>::value>
#endif  // defined(_LIBCUDACXX_HAS_TRIVIAL_CONSTRUCTOR) &&
        // !defined(_LIBCUDACXX_USE_HAS_TRIVIAL_CONSTRUCTOR_FALLBACK)
{
};
