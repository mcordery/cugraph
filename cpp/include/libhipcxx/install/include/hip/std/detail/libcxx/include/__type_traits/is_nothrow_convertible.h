...
_LIBCUDACXX_INLINE_VISIBILITY static bool_constant<
  noexcept(_CUDA_VSTD::__test_noexcept<_To>(_CUDA_VSTD::declval<_Fm>()))>
...
template <typename _Fm, typename _To>
_LIBCUDACXX_INLINE_VAR constexpr bool is_nothrow_convertible_v =
  is_nothrow_convertible<_Fm, _To>::value;
