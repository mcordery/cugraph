...
#if defined(_LIBCUDACXX_IS_LVALUE_REFERENCE) &&                                                  \
  !defined(_LIBCUDACXX_USE_IS_LVALUE_REFERENCE_FALLBACK) &&                                      \
  defined(_LIBCUDACXX_IS_RVALUE_REFERENCE) &&                                                    \
  !defined(_LIBCUDACXX_USE_IS_RVALUE_REFERENCE_FALLBACK) && defined(_LIBCUDACXX_IS_REFERENCE) && \
  !defined(_LIBCUDACXX_USE_IS_REFERENCE_FALLBACK)
