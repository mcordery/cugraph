...
inline _LIBCUDACXX_INLINE_VISIBILITY float strtof_l(const char* nptr, char** endptr, locale_t)
{
  return ::strtof(nptr, endptr);
}

inline _LIBCUDACXX_INLINE_VISIBILITY double strtod_l(const char* nptr, char** endptr, locale_t)
{
...
inline _LIBCUDACXX_INLINE_VISIBILITY long long strtoll_l(const char* nptr,
                                                         char** endptr,
                                                         int base,
                                                         locale_t)
{
...
inline _LIBCUDACXX_INLINE_VISIBILITY unsigned long long strtoull_l(const char* nptr,
                                                                   char** endptr,
                                                                   int base,
                                                                   locale_t)
{
...
inline _LIBCUDACXX_INLINE_VISIBILITY long long wcstoll_l(const wchar_t* nptr,
                                                         wchar_t** endptr,
                                                         int base,
                                                         locale_t)
{
...
inline _LIBCUDACXX_INLINE_VISIBILITY unsigned long long wcstoull_l(const wchar_t* nptr,
                                                                   wchar_t** endptr,
                                                                   int base,
                                                                   locale_t)
{
