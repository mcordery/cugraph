...
{
  if (__memorder != __ATOMIC_RELAXED) _Compiler_barrier();
}

static inline void __atomic_thread_fence(int __memorder)
{
  if (__memorder != __ATOMIC_RELAXED) _Memory_barrier();
}
...
template <class _Type, _enable_if_sized_as<_Type, 1> = 0>
bool __atomic_compare_exchange_relaxed(const volatile _Type* __ptr,
                                       _Type* __expected,
                                       const _Type* __desired)
{
  ...
  auto const __old =
    _InterlockedCompareExchange8((volatile char*)__ptr, __tmp_desired, __tmp_expected);
  if (__old == __tmp_expected) return true;
                                       ...
                                       const _Type* __desired)
{
  ...
  auto const __old =
    _InterlockedCompareExchange16((volatile short*)__ptr, __tmp_desired, __tmp_expected);
  if (__old == __tmp_expected) return true;
  *__expected = reinterpret_cast<const _Type&>(__old);
  return false;
}
                                       ...
                                       const _Type* __desired)
{
  ...
  auto const __old =
    _InterlockedCompareExchange((volatile long*)__ptr, __tmp_desired, __tmp_expected);
  if (__old == __tmp_expected) return true;
  *__expected = reinterpret_cast<const _Type&>(__old);
  return false;
}
                                       ...
                                       const _Type* __desired)
{
  ...
  auto const __old =
    _InterlockedCompareExchange64((volatile __int64*)__ptr, __tmp_desired, __tmp_expected);
  if (__old == __tmp_expected) return true;
  *__expected = reinterpret_cast<const _Type&>(__old);
  return false;
}
template <class _Type>
bool __atomic_compare_exchange(_Type volatile* __ptr,
                               _Type* __expected,
                               const _Type* __desired,
                               bool,
...
{
  auto const __old =
    _InterlockedExchange8((volatile char*)__ptr, reinterpret_cast<char const&>(*__val));
...
{
  auto const __old =
    _InterlockedExchange16((volatile short*)__ptr, reinterpret_cast<short const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
template <class _Type, _enable_if_sized_as<_Type, 4> = 0>
void __atomic_exchange_relaxed(const volatile _Type* __ptr, const _Type* __val, _Type* __ret)
{
  auto const __old =
    _InterlockedExchange((volatile long*)__ptr, reinterpret_cast<long const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
template <class _Type, _enable_if_sized_as<_Type, 8> = 0>
void __atomic_exchange_relaxed(const volatile _Type* __ptr, const _Type* __val, _Type* __ret)
{
  auto const __old =
    _InterlockedExchange64((volatile __int64*)__ptr, reinterpret_cast<__int64 const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
template <class _Type>
...
{
  auto const __old =
    _InterlockedExchangeAdd8((volatile char*)__ptr, reinterpret_cast<char const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
...
{
  auto const __old =
    _InterlockedExchangeAdd16((volatile short*)__ptr, reinterpret_cast<short const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
...
{
  auto const __old =
    _InterlockedExchangeAdd((volatile long*)__ptr, reinterpret_cast<long const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
...
{
  auto const __old =
    _InterlockedExchangeAdd64((volatile __int64*)__ptr, reinterpret_cast<__int64 const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
...
{
  auto const __old =
    _InterlockedAnd16((volatile short*)__ptr, reinterpret_cast<short const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
template <class _Type, class _Delta, _enable_if_sized_as<_Type, 4> = 0>
void __atomic_fetch_and_relaxed(const volatile _Type* __ptr, const _Delta* __val, _Type* __ret)
...
{
  auto const __old =
    _InterlockedAnd64((volatile __int64*)__ptr, reinterpret_cast<__int64 const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
template <class _Type, class _Delta>
...
{
  auto const __old =
    _InterlockedXor16((volatile short*)__ptr, reinterpret_cast<short const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
template <class _Type, class _Delta, _enable_if_sized_as<_Type, 4> = 0>
void __atomic_fetch_xor_relaxed(const volatile _Type* __ptr, const _Delta* __val, _Type* __ret)
...
{
  auto const __old =
    _InterlockedXor64((volatile __int64*)__ptr, reinterpret_cast<__int64 const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
template <class _Type, class _Delta>
...
{
  auto const __old =
    _InterlockedOr16((volatile short*)__ptr, reinterpret_cast<short const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
template <class _Type, class _Delta, _enable_if_sized_as<_Type, 4> = 0>
void __atomic_fetch_or_relaxed(const volatile _Type* __ptr, const _Delta* __val, _Type* __ret)
...
{
  auto const __old =
    _InterlockedOr64((volatile __int64*)__ptr, reinterpret_cast<__int64 const&>(*__val));
  *__ret = reinterpret_cast<_Type const&>(__old);
}
template <class _Type, class _Delta>
...
template <class _Type>
bool __atomic_compare_exchange_n(_Type volatile* __ptr,
                                 _Type* __expected,
                                 _Type __desired,
                                 bool __weak,
                                 int __success_memorder,
