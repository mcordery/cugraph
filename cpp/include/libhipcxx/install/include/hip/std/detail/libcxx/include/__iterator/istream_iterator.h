...
class _LIBCUDACXX_TEMPLATE_VIS istream_iterator
 ...
 public:
  _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR istream_iterator()
  ...
  {
    if (!(*__in_stream_ >> __value_)) __in_stream_ = 0;
  }
  ...
  friend _LIBCUDACXX_INLINE_VISIBILITY bool operator==(
...
inline _LIBCUDACXX_INLINE_VISIBILITY bool operator==(
  const istream_iterator<_Tp, _CharT, _Traits, _Distance>& __x,
