...
using __enable_if_bullet1 = __enable_if_t<is_member_function_pointer<_DecayFp>::value &&
...
template <class _Fp,
          ...
          class _DecayFp = __decay_t<_Fp>,
          class _DecayA0 = typename decay<_A0>::type>
using __enable_if_bullet2 = __enable_if_t<is_member_function_pointer<_DecayFp>::value &&
...
using __enable_if_bullet3 =
  __enable_if_t<is_member_function_pointer<_DecayFp>::value &&
                !is_base_of<_ClassT, _DecayA0>::value && !__is_reference_wrapper<_DecayA0>::value>;
...
template <class _Fp,
          ...
          class _DecayFp = __decay_t<_Fp>,
          class _DecayA0 = typename decay<_A0>::type>
using __enable_if_bullet5 = __enable_if_t<is_member_object_pointer<_DecayFp>::value &&
                                          __is_reference_wrapper<_DecayA0>::value>;
...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR decltype((
  _CUDA_VSTD::declval<_A0>().*_CUDA_VSTD::declval<_Fp>())(_CUDA_VSTD::declval<_Args>()...))
...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR decltype((
  _CUDA_VSTD::declval<_A0>().get().*_CUDA_VSTD::declval<_Fp>())(_CUDA_VSTD::declval<_Args>()...))
__invoke(_Fp&& __f, _A0&& __a0, _Args&&... __args)
...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR decltype(_CUDA_VSTD::declval<_A0>().*
                                                                    _CUDA_VSTD::declval<_Fp>())
__invoke(_Fp&& __f, _A0&& __a0) _NOEXCEPT_(noexcept(static_cast<_A0&&>(__a0).*__f))
{
...
inline _LIBCUDACXX_INLINE_VISIBILITY
  ...
  __invoke(_Fp&& __f, _A0&& __a0) _NOEXCEPT_(noexcept(__a0.get().*__f))
{
  return __a0.get().*__f;
}
...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR decltype(_CUDA_VSTD::declval<_Fp>()(
...
struct __nothrow_invokable_r_imp<true, false, _Ret, _Fp, _Args...> {
  ...
  template <class _Tp>
  _LIBCUDACXX_INLINE_VISIBILITY static void __test_noexcept(_Tp) _NOEXCEPT;
...
struct __nothrow_invokable_r_imp<true, true, _Ret, _Fp, _Args...> {
  static const bool value =
    noexcept(_CUDA_VSTD::__invoke(_CUDA_VSTD::declval<_Fp>(), _CUDA_VSTD::declval<_Args>()...));
};
...
template <class _Fp, class... _Args>
struct __invoke_of : public enable_if<__invokable<_Fp, _Args...>::value,
  ...
  static_assert(!__nv_is_extended_device_lambda_closure_type(_Fp),
                ...
                "hip::proclaim_return_type instead.");
#endif
};
