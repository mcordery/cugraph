...
struct __is_invalid_base_to_derived_cast {
  ...
  static const bool value = _And<_IsNotSame<_RawFrom, _RawTo>,
...
struct __is_invalid_lvalue_to_rvalue_cast<_ToRef&&, _FromRef&> {
  ...
  static const bool value =
    _And<_Not<is_function<_RawTo>>,
         _Or<_IsSame<_RawFrom, _RawTo>, is_base_of<_RawTo, _RawFrom>>>::value;
};
...
template <class _Tp, class... _Args>
_LIBCUDACXX_INLINE_VAR constexpr bool is_constructible_v =
  _LIBCUDACXX_IS_CONSTRUCTIBLE(_Tp, _Args...);
#endif
...
#endif  // defined(_LIBCUDACXX_IS_CONSTRUCTIBLE) &&
        // !defined(_LIBCUDACXX_USE_IS_CONSTRUCTIBLE_FALLBACK)
