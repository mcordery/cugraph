...
class _LIBCUDACXX_TEMPLATE_VIS ostreambuf_iterator
 ...
 public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY ostreambuf_iterator(streambuf_type* __s) _NOEXCEPT : __sbuf_(__s) {}
  _LIBCUDACXX_INLINE_VISIBILITY ostreambuf_iterator& operator=(_CharT __c)
  {
    if (__sbuf_ && traits_type::eq_int_type(__sbuf_->sputc(__c), traits_type::eof())) __sbuf_ = 0;
    return *this;
  }
  ...
  friend _LIBCUDACXX_HIDDEN _LIBCUDACXX_EXECUTION_SPACE_SPECIFIER ostreambuf_iterator<_Ch, _Tr>
