...
class _LIBCUDACXX_TEMPLATE_VIS istreambuf_iterator
 ...
 private:
  ...
  {
    if (__sbuf_ && traits_type::eq_int_type(__sbuf_->sgetc(), traits_type::eof())) __sbuf_ = 0;
    return __sbuf_ == 0;
  }
 ...
 public:
  ...
  _LIBCUDACXX_INLINE_VISIBILITY istreambuf_iterator(streambuf_type* __s) _NOEXCEPT : __sbuf_(__s) {}
