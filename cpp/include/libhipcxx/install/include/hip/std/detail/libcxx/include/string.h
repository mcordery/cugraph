...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD const char* strchr(
  const char* __s, int __c)
{
...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD const char* strpbrk(
  const char* __s1, const char* __s2)
{
  return __libcpp_strpbrk(__s1, __s2);
}
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD char* strpbrk(char* __s1,
                                                                                  const char* __s2)
{
  return __libcpp_strpbrk(__s1, __s2);
}
...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD const char* strrchr(
  const char* __s, int __c)
{
  return __libcpp_strrchr(__s, __c);
}
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD char* strrchr(char* __s,
                                                                                  int __c)
{
  return __libcpp_strrchr(__s, __c);
}
...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD const void* memchr(
  const void* __s, int __c, size_t __n)
{
  return __libcpp_memchr(__s, __c, __n);
}
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD void* memchr(void* __s,
                                                                                 int __c,
                                                                                 size_t __n)
{
  return __libcpp_memchr(__s, __c, __n);
...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD const char* strstr(
  const char* __s1, const char* __s2)
{
  return __libcpp_strstr(__s1, __s2);
}
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD char* strstr(char* __s1,
                                                                                 const char* __s2)
{
  return __libcpp_strstr(__s1, __s2);
}
