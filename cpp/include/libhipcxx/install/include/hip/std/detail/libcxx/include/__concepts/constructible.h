...
template <class _Tp>
concept __default_initializable = requires
{
  ::new _Tp;
};
...
template <class _Tp, class... _Args>
_LIBCUDACXX_CONCEPT_FRAGMENT(__constructible_from_,
                             requires()(requires(destructible<_Tp>),
...
_LIBCUDACXX_CONCEPT_FRAGMENT(
  ...
  requires(_Tp __unused = _Tp{})(requires(constructible_from<_Tp>),
...
_LIBCUDACXX_CONCEPT_FRAGMENT(__move_constructible_,
                             requires()(requires(constructible_from<_Tp, _Tp>),
...
_LIBCUDACXX_CONCEPT_FRAGMENT(
  ...
  requires()(requires(move_constructible<_Tp>),
             requires(constructible_from<_Tp, add_lvalue_reference_t<_Tp>>&&
                        convertible_to<add_lvalue_reference_t<_Tp>, _Tp>),
