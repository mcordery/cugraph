...
template <class _Tp>
inline _LIBCUDACXX_CONSTEXPR_AFTER_CXX14 _LIBCUDACXX_NO_CFI _LIBCUDACXX_INLINE_VISIBILITY _Tp*
...
template <class _Tp>
inline _LIBCUDACXX_NO_CFI _LIBCUDACXX_INLINE_VISIBILITY _Tp* addressof(_Tp& __x) _NOEXCEPT
{
...
template <class _Tp>
inline _LIBCUDACXX_INLINE_VISIBILITY __strong _Tp* addressof(__strong _Tp& __x) _NOEXCEPT
{
  return &__x;
}
...
template <class _Tp>
inline _LIBCUDACXX_INLINE_VISIBILITY __weak _Tp* addressof(__weak _Tp& __x) _NOEXCEPT
{
  return &__x;
}
#endif
...
template <class _Tp>
inline _LIBCUDACXX_INLINE_VISIBILITY __autoreleasing _Tp* addressof(
...
template <class _Tp>
inline _LIBCUDACXX_INLINE_VISIBILITY __unsafe_unretained _Tp* addressof(
