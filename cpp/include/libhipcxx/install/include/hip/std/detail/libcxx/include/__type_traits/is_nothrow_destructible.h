...
#if defined(_LIBCUDACXX_IS_NOTHROW_DESTRUCTIBLE) && \
  !defined(_LIBCUDACXX_USE_IS_NOTHROW_DESTRUCTIBLE_FALLBACK)
...
#endif  // defined(_LIBCUDACXX_IS_NOTHROW_DESTRUCTIBLE) &&
        // !defined(_LIBCUDACXX_USE_IS_NOTHROW_DESTRUCTIBLE_FALLBACK)
