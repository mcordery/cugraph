...
concept equality_comparable_with =
  ...
  equality_comparable<
    common_reference_t<__make_const_lvalue_ref<_Tp>, __make_const_lvalue_ref<_Up>>> &&
  __weakly_equality_comparable_with<_Tp, _Up>;

#elif _LIBCUDACXX_STD_VER > 11

template <class _Tp>
_LIBCUDACXX_CONCEPT_FRAGMENT(__with_lvalue_reference_,
                             requires()(typename(__make_const_lvalue_ref<_Tp>)));

template <class _Tp>
_LIBCUDACXX_CONCEPT _With_lvalue_reference = _LIBCUDACXX_FRAGMENT(__with_lvalue_reference_, _Tp);

template <class _Tp, class _Up>
_LIBCUDACXX_CONCEPT_FRAGMENT(__weakly_equality_comparable_with_,
...
template <class _Tp, class _Up>
_LIBCUDACXX_CONCEPT equality_comparable_with =
  _LIBCUDACXX_FRAGMENT(__equality_comparable_with_, _Tp, _Up);
