...
struct __derives_from_unary_function {
 private:
  ...
  static _LIBCUDACXX_INLINE_VISIBILITY __unary_function<_Ap, _Rp> __test(
    const volatile __unary_function<_Ap, _Rp>*);
...
struct __derives_from_binary_function {
 private:
  ...
  static _LIBCUDACXX_INLINE_VISIBILITY __binary_function<_A1, _A2, _Rp> __test(
    const volatile __binary_function<_A1, _A2, _Rp>*);
...
struct __weak_result_type_imp  // bool is true
  ...
  using result_type _LIBCUDACXX_NODEBUG_TYPE _LIBCUDACXX_DEPRECATED_IN_CXX17 =
    typename _Tp::result_type;
#endif
};

template <class _Tp>
struct __weak_result_type_imp<_Tp, false> : public __maybe_derive_from_unary_function<_Tp>,
                                            public __maybe_derive_from_binary_function<_Tp> {};
