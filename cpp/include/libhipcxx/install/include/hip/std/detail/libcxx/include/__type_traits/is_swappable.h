...
template <class _Tp>
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_CONSTEXPR_AFTER_CXX17 __swap_result_t<_Tp> swap(
  _Tp& __x, _Tp& __y)
...
struct __swappable_with {
  ...
  _LIBCUDACXX_INLINE_VISIBILITY static decltype(swap(_CUDA_VSTD::declval<_LHS>(),
                                                     _CUDA_VSTD::declval<_RHS>()))
  __test_swap(int);
