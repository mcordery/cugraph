...
_LIBCUDACXX_CONCEPT_FRAGMENT(__common_type_exists_,
                             requires()(typename(common_type_t<_Tp, _Up>),
...
template <class _Tp, class _Up>
_LIBCUDACXX_CONCEPT _Common_type_constructible =
  _LIBCUDACXX_FRAGMENT(__common_type_constructible_, _Tp, _Up);
...
_LIBCUDACXX_CONCEPT_FRAGMENT(
  ...
  requires()(
    ...
    requires(
      common_reference_with<add_lvalue_reference_t<const _Tp>, add_lvalue_reference_t<const _Up>>),
    requires(common_reference_with<add_lvalue_reference_t<common_type_t<_Tp, _Up>>,
