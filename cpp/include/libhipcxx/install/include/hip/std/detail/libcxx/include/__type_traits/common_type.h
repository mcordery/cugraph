...
struct __common_type2_imp<_Tp, _Up, __void_t<decltype(true ? declval<_Tp>() : declval<_Up>())>> {
  typedef _LIBCUDACXX_NODEBUG_TYPE __decay_t<decltype(true ? declval<_Tp>() : declval<_Up>())> type;
};
...
template <class _Tp, class _Up>
struct __common_type_impl<__common_types<_Tp, _Up>,
...
struct __common_type_impl<__common_types<_Tp, _Up, _Vp _LIBCUDACXX_OPTIONAL_PACK(_Rest...)>,
                          __void_t<typename common_type<_Tp, _Up>::type>>
...
template <class _Tp, class _Up, class _Vp _LIBCUDACXX_OPTIONAL_PACK(class... _Rest)>
struct _LIBCUDACXX_TEMPLATE_VIS common_type<_Tp, _Up, _Vp _LIBCUDACXX_OPTIONAL_PACK(_Rest...)>
  : __common_type_impl<__common_types<_Tp, _Up, _Vp _LIBCUDACXX_OPTIONAL_PACK(_Rest...)>> {};
