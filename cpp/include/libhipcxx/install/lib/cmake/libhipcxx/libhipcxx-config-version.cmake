...
file(READ "${_libhipcxx_VERSION_INCLUDE_DIR}/hip/std/detail/__config" libhipcxx_VERSION_HEADER)

string(REGEX MATCH "#define[ \t]+_LIBCUDACXX_CUDA_API_VERSION[ \t]+([0-9]+)" unused_var "${libhipcxx_VERSION_HEADER}")
